...
coefficients_str = ' + '.join([f'{coef:.2f} * {var}' for coef, var in zip(coefficients, ['cement (kg)', 'age (days)'])])
...
print('Coefficients:')
for var, coef in zip(['cement (kg)', 'age (days)'], coefficients):
    print(f'{var}: {coef:.2f}')
