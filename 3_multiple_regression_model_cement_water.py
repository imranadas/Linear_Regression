...
coefficients_str = ' + '.join([f'{coef:.2f} * {var}' for coef, var in zip(coefficients, ['cement (kg)', 'water (kg)'])])
...
print('Coefficients:')
for var, coef in zip(['cement (kg)', 'water (kg)'], coefficients):
    print(f'{var}: {coef:.2f}')
